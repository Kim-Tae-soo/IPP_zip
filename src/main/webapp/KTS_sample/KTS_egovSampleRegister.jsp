    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_egov_detail(id) {
        	document.detailForm.selectedId.value = id;
           	document.detailForm.action = "<c:url value='/viewSample.do'/>";
           	document.detailForm.submit();
        }
        ...
        function fn_egov_save() {
        	...
        	if(!validateKTS_SampleVO(frm)){
            	...
            	frm.action = "<c:url value="${registerFlag == 'create' ? '/addSampleView.do' : '/updateSample.do'}"/>";
                frm.submit();
            }
        }
...
<form:form modelAttribute="KTS_SampleVO" id="detailForm" name="detailForm" enctype="multipart/form-data">
	<input type="hidden" name="selectedId" />
    <div id="content_pop">
    	<!-- 타이틀 -->
    	<div id="title">
    		<ul>
    			<li><img src="<c:url value='/images/KTS_egovframework/KTS_example/title_dot.gif'/>" alt=""/>
    	...
    	<table width="100%" border="1" cellpadding="0" cellspacing="0" style="bordercolor:#D3E2EC; bordercolordark:#FFFFFF; BORDER-TOP:#C2D0DB 2px solid; BORDER-LEFT:#ffffff 1px solid; BORDER-RIGHT:#ffffff 1px solid; BORDER-BOTTOM:#C2D0DB 1px solid; border-collapse: collapse;">
    		...
    		<tr>
    			...
    			<td class="tbtd_content">
    				<form:input path="name" maxlength="30" cssClass="txt"/>&nbsp;<form:errors path="name" />
    			</td>
    		</tr>
    		<tr>
    		...
    		<tr>
    			<td class="tbtd_caption"><label for="uploadfile"><spring:message code="title.smaple.uploadfile" /></label></td>
    			<td class="tbtd_content">
